...
class MorphineResponseExtractor:
    ...
    def extract_post_dose_activity(self, cage_id, replicate, dose_number=1, 
        ...
        # Get all dates that might be involved
        dates_involved = []
...
def main():
    ...
    print("Using 50-250 minute window (hyperlocomotion phase based on time-course data)")
    
    # Extract responses for first dose during hyperlocomotion phase
